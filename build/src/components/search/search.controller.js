...
const transformer = __importStar(require("../post/post.transformer"));
...
class SearchController {
    get(queryParam, offset, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield search_service_1.default.searchPosts(queryParam, 1, 10);
